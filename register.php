...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) { // rowCount() para PDO verificar número de linhas
                ...
                if ($stmt_insert->execute()) {
                    ...
                    $error_message = "Erro ao cadastrar: " . $stmt_insert->errorInfo()[2]; // errorInfo()[2] para obter mensagem de erro PDO
                }
            }
...
<div class="container">
    <div class="register-container">
        ...
        <?php if (!empty($success_message)): ?>
            <div class="alert alert-light" role="alert" style="background-color: rgba(255, 255, 255, 0.85); color: #155724; font-weight: bold;">
                <?php echo $success_message; ?> <a href="index.php">Fazer Login</a>
            </div>
        <?php endif; ?>
        <?php if (!empty($error_message)): ?>
            <div class="alert alert-danger" role="alert" style="background-color: rgba(255, 255, 255, 0.85); color: #721c24; font-weight: bold;">
